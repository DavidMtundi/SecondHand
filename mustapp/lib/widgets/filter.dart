      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          SingleChildScrollView(
            child: Row(
              children: <Widget>[
                ...
                buildChip("Samsung", Theme.of(context).primaryColor, "A",
                    Theme.of(context).primaryColor),
                buildChip(
                    "Nokia", Colors.grey.shade400, "A", Colors.grey.shade600),
                buildChip(
          ...
          Row(
            children: <Widget>[
              buildChip(
                  "Vodap", Colors.grey.shade400, "A", Colors.grey.shade600),
              buildChip(
                  "Iphone", Colors.grey.shade400, "A", Colors.grey.shade600),
              buildChip(
                  "Wired", Colors.grey.shade400, "A", Colors.grey.shade600),
              buildChip(
                  "Charger", Colors.grey.shade400, "A", Colors.grey.shade600),
            ],
          ),
          Padding(
          ...
          Padding(
            ...
            child: Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: <Widget>[
                Text("Kshs " + '$_lowerValue'),
                Text("Kshs " + '$_upperValue'),
              ],
            ),
          ),
          FlutterSlider(
